...
with open('/home/idelcano/EyeSeeTea/to_remove/ESTools/DHIS2/metadata_manipulation/csv2dhis/orgunits_sri_lanka_level5.json') as f:
    data = json.load(f)
    with open('sri_lanka_ss.csv') as csv_file:
            ...
            if line_count == 0:
                ...
                for org_unit in data["organisationUnits"]:
                    if row[2] == org_unit["name"] or row[2] == org_unit["shortName"]:
                        ...
                        if row[9] == "":
                            orgunit_list.append(
                            {"id": get_code(), "name": row[6], "shortName": row[6], "code": row[7], "featureType": "NONE",
                            ...
                            orgunit_list.append(
                            {"id": get_code(), "name": row[6], "shortName": row[6], "code": row[7], "featureType": "POINT",
        ...
        with open('sri_lanka_ss.json', 'w') as outfile:
